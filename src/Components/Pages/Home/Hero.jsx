...
const Hero = () => {
      return (
            <section className="w-full min-h-[90vh] bg-[#f3f4f6] flex items-center justify-center px-6 md:px-12 lg:px-20 py-12 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-orange-500/5 blur-[100px] rounded-full -ml-32 -mb-32"></div>
                  ...
                  <div className="w-full max-w-7xl grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
                        ...
                        <div className="space-y-8">
                              ...
                              {/* Animated Badge */}
                              <div className="inline-flex items-center gap-3 bg-white border border-blue-100 shadow-sm px-4 py-2 rounded-full group cursor-default">
                                    <span className="relative flex h-3 w-3">
                                          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                                          <span className="relative inline-flex rounded-full h-3 w-3 bg-blue-600"></span>
                                    </span>
                                    <span className="text-xs md:text-sm font-bold text-blue-900 uppercase tracking-wider">
                              ...
                              <div className="space-y-2">
                                    <h1 className="font-black text-[#0b1d4d] leading-[1.05] tracking-tight
              text-[clamp(2.5rem,8vw,5.5rem)]">
                                          Intelligent Power <br />
                                          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0b1d4d] via-blue-700 to-blue-500">
                                                Distribution.
                                          </span>
                                    </h1>
                                    <p className="text-[#0b1d4d]/60 font-bold uppercase tracking-[0.2em] text-sm md:text-base">
            ...
            text-[clamp(1rem,2vw,1.25rem)]">
                        ...
                        <div className="relative group">
                              ...
                              <div className="absolute -inset-4 bg-gradient-to-tr from-blue-500 to-orange-500 opacity-10 blur-2xl rounded-[3rem] group-hover:opacity-20 transition-opacity"></div>
